                        ...
                        cate:function(){
                            ...
                            for (var i = arr.length - 1; i >= 0; i--) {
                                ...
                                if(arr[i].name.length>20){
                                    arr[i].name=arr[i].name.slice(0,20)+"...";
                                }
                                ...
                                arr[i].child=substr(arr[i].child);
                            }
                            return arr;
                        },
                        pic1:function() {
            ...
            <div class="p_show right" id="list">
                ...
                <div class="prod_warp one clear">
                    ...
                    <div style="border-bottom: 1px solid #595959 ">
                        <div class="prod" v-for="i in list" style="width: 305px;">
                            <a style="width: 305px;" href="{{i.url}}"><img style="width: 305px;" src="{{i.tbpic}}"></a>
                            <span style="width: 305px;">{{i.title}}</span>
                        </div>
                    </div>
                    ...
                    <div class="page">
                        <p class="page_link">
                            ...
                            <template v-if="pageNum <3">
                                <span v-if="i ==(curentPage-1)" style="background-color: #09529f;color: #fff;" class="page_link_a" v-for="i in pageNum">{{i+1}}</span>
                                <span v-if="i !=(curentPage-1)" class="page_link_a" v-for="i in pageNum">{{i+1}}</span>
                            </template>
                            <template v-else>
