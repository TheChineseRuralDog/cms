...
<!--             </ul> -->
            <div class="p_show right" id="list">
                <div class="page_now"><span><a href="/index.php?m=Chinese&c=Index">Index</a></span><span>><a href="{{currentCate.url}}">{{currentCate.name}}</a></span><span v-if="currentCate2Mark==1" style="text-decoration: none;color: #676869;">>{{currentCate2.name}}</span></div>
                <div class="prod_warp one">
